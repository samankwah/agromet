    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-50 flex items-start sm:items-center justify-center p-2 sm:p-4">
      <div className="neo-table-shell-xl w-full max-w-7xl max-h-screen sm:max-h-[95vh] overflow-y-auto mt-2 sm:mt-0">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 sm:p-6 border-b border-neo-border sticky top-0 bg-neo-surface z-10 space-y-3 sm:space-y-0">
          <div>
            <h2 className="text-xl font-semibold text-neo-text">Upload Poultry Advisory</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      errors.poultryTypeCode ? 'border-red-500' : 'border-neo-border'
                    }`}
                  >
            ...
            <div className="space-y-6">
                  ...
                  <div key={index} className={`border rounded-lg ${selectedSheets.includes(sheet.name) ? 'border-blue-300 bg-blue-50' : 'border-neo-border'}`}>
                    <div className="p-4">
                      ...
                      <div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          <span className="font-medium text-neo-text">Columns:</span>
                          <span className="ml-1 text-neo-muted">{sheet.summary.columns || 0}</span>
                        </div>
                        <div>
              ...
              <div className="flex justify-between">
                <button
                  ...
                  className="px-6 py-2 bg-neo-text text-neo-bg rounded-md hover:bg-neo-accent-strong"
                >
                  Back
                </button>
                <button
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-neo-surface neo-surface-soft p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div>
                      <span className="font-medium text-neo-text">Poultry Type:</span>
                      <span className="ml-2">{previewData.poultryTypeCode} - {previewData.poultryTypeName}</span>
                    </div>
                    {previewData.breedCode && (
                      <div>
                        <span className="font-medium text-neo-text">Breed:</span>
              ...
              <div className="flex justify-between">
                ...
                <div className="space-x-3">
                  <button
                    onClick={handleReset}
                    className="px-6 py-2 bg-neo-muted/35 text-neo-text rounded-md hover:bg-neo-muted/45"
                    disabled={loading}
                  >
                    Start Over
                  </button>
